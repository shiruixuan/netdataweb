...
function notifyForUpdate(force) {
    ...
    checkForUpdateByVersion(force, function (sha1, sha2) {
        ...
        if (sha1 === null) {
            save = false;
            versionLog('<p><big>netdata 版本获取失败！</big></p><p>You can always get the latest netdata from <a href="https://github.com/netdata/netdata" target="_blank">its github page</a>.</p>');
        } else if (sha2 === null) {
            save = false;
